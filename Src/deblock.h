...
private:
	...
	template<>
	void deblockHorEdge(float * VS_RESTRICT dstp, const unsigned stride) noexcept;
	template<typename T>
	void deblockVerEdge(T * VS_RESTRICT dstp, const unsigned stride) noexcept;
	template<>
	void deblockVerEdge(float * VS_RESTRICT dstp, const unsigned stride) noexcept;
	template<typename T>
    ...
    template<typename T>
    void deblockEdgeOPT(T* VS_RESTRICT dstp, const unsigned stride,int mode);
    template<>
    ...
    template<typename T>
    void deblockEdgeOPT8(T* VS_RESTRICT dstp, const unsigned stride, int mode);
    template<>
...
static inline void transpose_8bit_6x8(__m128i in0, __m128i in1, __m128i in2, __m128i in3, __m128i in4, __m128i in5, __m128i in6, __m128i in7,
    ...
    // b0: 00 10 20 30 01 11 21 31  02 12 22 32 03 13 23 33
    // b1: 04 14 24 34 05 15 25 35  06 16 26 36 07 17 27 37
    // b2: 40 50 60 70 41 51 61 71  42 52 62 72 43 53 63 73
...
static inline void transpose_16bit_6x8(
    __m128i in0, __m128i in1, __m128i in2, __m128i in3, __m128i in4, __m128i in5, __m128i in6, __m128i in7,
    __m128i& out0, __m128i& out1, __m128i& out2, __m128i& out3, __m128i& out4, __m128i& out5) {
    // Unpack 16 bit elements. Goes from:
    // in[0]: 00 01 02 03  04 05 06 07
    // in[1]: 10 11 12 13  14 15 16 17
    ...
    const __m128i a0 = _mm_unpacklo_epi16(in0, in1);
    const __m128i a1 = _mm_unpacklo_epi16(in2, in3);
    const __m128i a2 = _mm_unpacklo_epi16(in4, in5);
    const __m128i a3 = _mm_unpacklo_epi16(in6, in7);
    const __m128i a4 = _mm_unpackhi_epi16(in0, in1);
    const __m128i a5 = _mm_unpackhi_epi16(in2, in3);
    const __m128i a6 = _mm_unpackhi_epi16(in4, in5);
    const __m128i a7 = _mm_unpackhi_epi16(in6, in7);
    ...
    // out[4]: 04 14 24 34  44 54 64 74
    // out[5]: 05 15 25 35  45 55 65 75
    out0 = _mm_unpacklo_epi64(b0, b1);
    out1 = _mm_unpackhi_epi64(b0, b1);
    out2 = _mm_unpacklo_epi64(b4, b5);
    out3 = _mm_unpackhi_epi64(b4, b5);
    out4 = _mm_unpacklo_epi64(b2, b3);
    out5 = _mm_unpackhi_epi64(b2, b3);
}

static inline void transpose_16bit_8x4(
    __m128i in0, __m128i in1, __m128i in2, __m128i in3,
    __m128i& out0, __m128i& out1, __m128i& out2, __m128i& out3, __m128i& out4, __m128i& out5, __m128i& out6, __m128i& out7) {
    ...
    out4 = _mm_unpacklo_epi64(b2, zeros);
    out5 = _mm_unpackhi_epi64(b2, zeros);
    out6 = _mm_unpacklo_epi64(b6, zeros);
    out7 = _mm_unpackhi_epi64(b6, zeros);
}